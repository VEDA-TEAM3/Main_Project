...
int main(void)
{
  ...
  if (veda_channel_mutex_create() == 0U)
  {
    Error_Handler();
  }
  ...
  if ((veda_downlink_queue_create() == 0U) || (veda_tasks_queue_create() == 0U) ||
      (veda_uplink_queue_create() == 0U) || (veda_rs485_queue_create() == 0U))
  {
    Error_Handler();
  }
  ...
  if ((defaultTaskHandle == NULL) || (veda_tasks_create() == 0U))
  {
    Error_Handler();
  }
