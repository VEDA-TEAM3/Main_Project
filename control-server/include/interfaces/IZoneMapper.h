 ...
 * ICrossChannelFuser 의 dedup 이후, IRiskPolicy 이전 단계에서 실행되어야 함
...
public:
     ...
     * @param frame 배정 대상 프레임. 각 WorldObject.zoneId 가 in-place 로 채워짐
     * @note IRiskPolicy::evaluate 와 동일하게 mutate 패턴 사용
     */
