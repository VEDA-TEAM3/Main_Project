 ...
 * -- pipeline 스레드가 잘못된 패킷 하나 때문에 죽으면 안 됨
 */
...
/**
 * @brief Metadata 입력을 추상화한 파서 인터페이스
 */
...
public:
    ...
    /**
     * @brief   원본 Metadata 패킷을 파싱하여 내부용 ChannelFrame으로 변환
     *
     * @param   raw 파싱할 원본 Metadata 패킷
