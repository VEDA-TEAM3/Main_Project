...
- [Summary](#summary)
- [00. Setup](#00-setup)
    - [0.1 사용자 정보 등록](#01-사용자-정보-등록)
    - [0.2 원격 저장소 복제](#02-원격-저장소-복제)
- [01. Develop](#01-develop)
    - [01.1 개발 준비](#011-개발-준비)
    - [01.2 개발 완료](#012-개발-완료)
      - [Commit Tag](#commit-tag)
- [02. PR](#02-pr)
    - [PR 본문 (복사해서 사용)](#pr-본문-복사해서-사용)
- [03. Code Review](#03-code-review)
- [04. Next Task](#04-next-task)
...
## 03. Code Review
코드 리뷰를 배정받은 팀원들은 코드를 확인하고 피드백을 남깁니다. 이상이 없다면 `Approve`를 누릅니다.
